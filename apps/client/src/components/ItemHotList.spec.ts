...
describe('ItemHotList', () => {
  ...
  it('should pass item prop to ListItem', () => {
    ...
    expect(listItemVM.item).toEqual(MOCK_ITEM_HOT);
  });
  ...
  it('should pass id prop to ItemDetailsModal', async () => {
    ...
    expect(itemDetailsModalAttributes.id).toBe(String(MOCK_ITEM_HOT.id));
  });
  ...
  it('should pass enhancement prop to ItemDetailsModal', async () => {
    ...
    expect(itemDetailsModalAttributes.enhancement).toBe(String(MOCK_ITEM_HOT.enhancement));
  });
});
