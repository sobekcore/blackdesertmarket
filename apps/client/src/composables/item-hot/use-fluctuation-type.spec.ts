...
import { useFluctuationType } from '@/composables/item-hot/use-fluctuation-type';

const MOCK_FLUCTUATION_TYPE: number = 1;
...
describe('useFluctuationType', () => {
  ...
  beforeEach(() => {
    component = defineComponent({
      setup() {
        return useFluctuationType(MOCK_FLUCTUATION_TYPE);
      },
      template: '<slot></slot>',
    });
