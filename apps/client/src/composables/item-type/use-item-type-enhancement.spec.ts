...
import { ItemEnhancementNameData, useItemTypeEnhancement } from '@/composables/item-type/use-item-type-enhancement';

const MOCK_ITEM_TYPE: BlackDesertItemType = mockBlackDesertItemType();

describe('useItemTypeEnhancement', () => {
  ...
  beforeEach(() => {
    component = defineComponent({
      setup() {
        return useItemTypeEnhancement(MOCK_ITEM_TYPE);
      },
      template: '<slot></slot>',
    });
